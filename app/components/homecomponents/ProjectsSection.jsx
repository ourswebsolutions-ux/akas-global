    ...
    <section className="relative w-full min-h-[700px] sm:min-h-[900px] flex items-center justify-center py-14 sm:py-20 overflow-hidden">
      ...
      <div className="relative w-full max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-12 flex flex-col items-center">
        ...
        >
          ...
          <motion.h2
            className="text-[28px] sm:text-[44px] md:text-[44px] lg:text-[52px] font-bold text-white leading-[1.15] sm:leading-[1.05] mb-4 sm:mb-5"
            variants={{
          ...
          <motion.p
            className="text-[13px] sm:text-[15px] text-white/75 max-w-[560px] leading-relaxed mb-6 sm:mb-8 px-1"
            variants={{
