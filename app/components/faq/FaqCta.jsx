      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        >
          ...
          >
            ...
            <motion.h2
              className="text-[26px] sm:text-[42px] md:text-[56px] lg:text-[40px] font-bold leading-[1.15] sm:leading-[1.05] text-white mb-7 sm:mb-10"
              variants={{
            ...
            >
Have Any Other Question? Reach Out, We’re
              <br />
Always Listening
            </motion.h2>
